...
function tableSortJs(testingTableSortJS = false, domDocumentWindow = document) {
    ...
    function makeEachColumnSortable(th, columnIndex, tableBody, sortableTable) {
      ...
      const arrowUp = '<i class="fa-sharp fa-solid fa-caret-up"></i>';
      const arrowDown = '<i class="fa-sharp fa-solid fa-caret-down"></i>';;
      ...
      function getTableData(
        ...
        function clearArrows(arrowUp = '<i class="fa-sharp fa-solid fa-caret-up"></i>', arrowDown = '<i class="fa-sharp fa-solid fa-caret-up"></i>') {
